...
import (
	...
	testdata "github.com/wxsatellite/goweb/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/wxsatellite/goweb/framework/gin.handlerNameTest$", c.HandlerName())
}
